    ...
    <div className="bg-gray-900">
        ...
        <div className="max-w-7xl pl-18">
          <div className="relative z-10 pb-8 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                ...
                <div className="mt-5 gap-x-3 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                    <Link
                      to="/Register"
      ...
      <div className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h2 className="text-base text-center text-blue-400 font-semibold tracking-wide uppercase">Features</h2>
            <p className="mt-2 text-3xl text-center font-extrabold text-white sm:text-4xl">
              Everything you need to land your dream job
            </p>
            <p className="mt-4 max-w-2xl text-center mx-auto text-xl text-gray-400">
      ...
      <div className="relative">
        ...
        <div className="relative max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
            ...
            <p className="mt-4 text-lg leading-6 text-gray-200">
              ...
              <Link
                to="/signup"
                className="inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md  text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700  hover:bg-gray-50 sm:w-auto mt-4"
              >
                Get Started Free
              </Link>
        </div>
